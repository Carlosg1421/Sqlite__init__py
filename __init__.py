    ...
    if opcion == 1:
        ...
        while True:
            ...
            if opcion == 1:
                ...
                conn.execute(
                    "INSERT INTO PRODUCTO(ID, NOMBRE, TIPO, CANTIDAD) VALUES(" + id + ", \"" + nombre + "\", \"" + tipo + "\", \"" + cantidad + "\")")
                conn.commit()
            elif opcion == 2:
                id = input("ID?")
                nombre = input("Nombre?")
                ...
                conn.execute(
                    "INSERT INTO PROVEEDORES(ID, NOMBRE, UBICACION, CLASIFICACION) VALUES(" + id + ", \"" + nombre + "\", \"" + ubicacion + "\", \"" + clasificacion + "\")")
                conn.commit()
            elif opcion == 3:
                id = input("ID?")
                nombre = input("Nombre?")
                ...
                clasificacion = input("Clasificacion?")
                conn.execute(
                    "INSERT INTO DISTRIBUIDORES(ID, NOMBRE, UBICACION, CLASIFICACION) VALUES(" + id + ", \"" + nombre + "\", \"" + ubicacion + "\", \"" + clasificacion + "\")")
                conn.commit()
            elif opcion == 4:
                print("Regresando al menú principal🤷")
                break
